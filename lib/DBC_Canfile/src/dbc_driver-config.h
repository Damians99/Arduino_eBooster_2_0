...
// DBC filename      : Pony_wo_com_matrix.dbc
#pragma once
...
/* #define DBC_DRIVER_USE_BITS_SIGNAL */
...
#define DBC_DRIVER_USE_CANSTRUCT
...
/* #define DBC_DRIVER_USE_SIGFLOAT */
...
/* #define DBC_DRIVER_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (DBC_DRIVER_USE_DIAG_MONITORS) and define below
...
/* #define DBC_DRIVER_USE_MONO_FMON */
